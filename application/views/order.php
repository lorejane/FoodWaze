...
<div class="col-sm-4">
	...
	<div class="menu row" >
		...
		<button type="button" name="mulbtn" value="*" onclick="displaynum(mulbtn.value)" class="keypad btn btn-warning">*</button>
		<button type="button" name="subbtn" value="-" onclick="displaynum(subbtn.value)" class="keypad btn btn-warning">-</button><br/>
		...
		<button type="button" name="addbtn" value="+" onclick="displaynum(addbtn.value)" class="keypad btn btn-warning">+</button>
		<button type="button" name="divbtn" value="/" onclick="displaynum(divbtn.value)" class="keypad btn btn-warning">/</button>
